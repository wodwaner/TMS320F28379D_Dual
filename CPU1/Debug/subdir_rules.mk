...
%.obj: ../%.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	...
	"/Applications/ti/ccs1281/ccs/tools/compiler/ti-cgt-c2000_22.6.1.LTS/bin/cl2000" -v28 -ml -mt --cla_support=cla1 --float_support=fpu32 --tmu_support=tmu0 --vcu_support=vcu2 -O0 --fp_mode=relaxed --include_path="/Volumes/SSD/ti/workspace_v12/F28379D_Dual_Cpu1" --include_path="/Applications/ti/ccs1281/ccs/tools/compiler/ti-cgt-c2000_22.6.1.LTS/include" --include_path="/Volumes/SSD/ti/C2000Ware_5_04_00_00/device_support/f2837xd/headers/include" --include_path="/Volumes/SSD/ti/C2000Ware_5_04_00_00/device_support/f2837xd/common/include" --include_path="/Volumes/SSD/ti/C2000Ware_5_04_00_00/libraries/math/CLAmath/c28/include" --define=CLA_MATH_TABLES_IN_ROM=1 --define=CPU1 --define=_LAUNCHXL_F28379D -g --diag_warning=225 --diag_wrap=off --display_error_number --abi=coffabi --preproc_with_compile --preproc_dependency="$(basename $(<F)).d_raw" $(GEN_OPTS__FLAG) "$<"
